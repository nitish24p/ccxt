...
module.exports = function (_Exchange) {
    (0, _inherits3.default)(_1broker, _Exchange);

    function _1broker() {
        (0, _classCallCheck3.default)(this, _1broker);
        return (0, _possibleConstructorReturn3.default)(this, (_1broker.__proto__ || (0, _getPrototypeOf2.default)(_1broker)).apply(this, arguments));
    }

    (0, _createClass3.default)(_1broker, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend((0, _get3.default)(_1broker.prototype.__proto__ || (0, _getPrototypeOf2.default)(_1broker.prototype), 'describe', this).call(this), {
                'id': '_1broker',
                'name': '1Broker',
                'countries': 'US',
                'rateLimit': 1500,
