...
module.exports = function (_Exchange) {
    ...
    function acx() {
        ...
        return _possibleConstructorReturn(this, (acx.__proto__ || Object.getPrototypeOf(acx)).apply(this, arguments));
    }

    _createClass(acx, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend(_get(acx.prototype.__proto__ || Object.getPrototypeOf(acx.prototype), 'describe', this).call(this), {
                'id': 'acx',
                'name': 'ACX',
                'countries': 'AU',
                'rateLimit': 1000,
