...
module.exports = function (_Exchange) {
    (0, _inherits3.default)(acx, _Exchange);

    function acx() {
        (0, _classCallCheck3.default)(this, acx);
        return (0, _possibleConstructorReturn3.default)(this, (acx.__proto__ || (0, _getPrototypeOf2.default)(acx)).apply(this, arguments));
    }

    (0, _createClass3.default)(acx, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend((0, _get3.default)(acx.prototype.__proto__ || (0, _getPrototypeOf2.default)(acx.prototype), 'describe', this).call(this), {
                'id': 'acx',
                'name': 'ACX',
                'countries': 'AU',
                'rateLimit': 1000,
        ...
        value: function encodeParams(params) {
            if ('orders' in params) {
                ...
                for (var i = 0; i < orders.length; i++) {
                    var order = orders[i];
                    var keys = (0, _keys2.default)(order);
