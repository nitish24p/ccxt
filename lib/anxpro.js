...
module.exports = function (_Exchange) {
    ...
    function anxpro() {
        ...
        return _possibleConstructorReturn(this, (anxpro.__proto__ || Object.getPrototypeOf(anxpro)).apply(this, arguments));
    }

    _createClass(anxpro, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend(_get(anxpro.prototype.__proto__ || Object.getPrototypeOf(anxpro.prototype), 'describe', this).call(this), {
                'id': 'anxpro',
                'name': 'ANXPro',
        ...
        key: 'withdraw',
        value: function () {
            var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(currency, amount, address) {
                var params = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
