...
module.exports = function () {
    ...
    function Exchange() {
        ...
        _Object$assign(this, functions, { encode: function encode(string) {
                return string;
        ...
        try {
            for (var _iterator = _getIterator(_Object$entries(config)), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    ...
    _createClass(Exchange, [{
        ...
        value: function defineRestApi(api, methodName) {
            ...
            var _loop = function _loop(type) {
                ...
                try {
                    for (var _iterator3 = _getIterator(_Object$keys(api[type])), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
            ...
            try {
                ...
                for (var _iterator2 = _getIterator(_Object$keys(api)), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
        ...
        key: 'fetch2',
        value: function () {
            var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2(path) {
        ...
        value: function () {
            var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee5(symbol) {
                var params = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
                var orderbook;
        ...
        value: function () {
            var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee6(part) {
                var params = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
                var balance;
        ...
        key: 'editOrder',
        value: function () {
            var _ref9 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee7(id, symbol) {
