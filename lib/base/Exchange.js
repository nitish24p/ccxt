...
module.exports = function () {
    ...
    function Exchange() {
        ...
        Object.assign(this, functions, { encode: function encode(string) {
                return string;
    ...
    _createClass(Exchange, [{
        ...
        value: function defineRestApi(api, methodName) {
            ...
            var _loop = function _loop(type) {
                ...
                try {
                    for (var _iterator3 = Object.keys(api[type])[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
            ...
            try {
                ...
                for (var _iterator2 = Object.keys(api)[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
        ...
        value: function fetch(url) {
            ...
            if (isNode && this.userAgent) {
                if (typeof this.userAgent == 'string') headers = extend({ 'User-Agent': this.userAgent }, headers);else if (_typeof(this.userAgent) == 'object' && 'User-Agent' in this.userAgent) headers = extend(this.userAgent, headers);
            }
        ...
        value: function setMarkets(markets) {
            ...
            var values = Object.values(markets).map(function (market) {
                return deepExtend({
            ...
            if (currencies) {
                ...
                var _currencies = Object.keys(groupedCurrencies).map(function (code) {
        ...
        value: function parseBidsAsks(bidasks) {
            ...
            return Object.values(bidasks || []).map(function (bidask) {
        ...
        value: function () {
            var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(symbol) {
                var params = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
                var orderbook;
        ...
        value: function getCurrencyUsedOnOpenOrders(currency) {
            ...
            return Object.values(this.orders).filter(function (order) {
            ...
            currencies.forEach(function (currency) {
                ...
                if (typeof balance[currency].used == 'undefined') {
                    ...
                    if (_this11.parseBalanceFromOpenOrders && 'open_orders' in balance['info']) {
                        ...
                        var cachedOrdersCount = Object.values(_this11.orders).filter(function (order) {
                            return order['status'] == 'open';
                        }).length;
        ...
        value: function () {
            var _ref8 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(part) {
                var params = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
                var balance;
        ...
        value: function parseTrades(trades) {
            ...
            var result = Object.values(trades).map(function (trade) {
        ...
        value: function parseOrders(orders) {
            ...
            var result = Object.values(orders).map(function (order) {
        ...
        key: 'editOrder',
        value: function () {
            var _ref9 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(id, symbol) {
                ...
                return regeneratorRuntime.wrap(function _callee7$(_context7) {
                    while (1) {
                        switch (_context7.prev = _context7.next) {
                            ...
                            case 4:
                                return _context7.abrupt('return', this.createOrder.apply(this, [symbol].concat(_toConsumableArray(args))));
