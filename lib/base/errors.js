...
var BaseError = function (_Error) {
    ...
    function BaseError(message) {
        ...
        var _this = _possibleConstructorReturn(this, (BaseError.__proto__ || _Object$getPrototypeOf(BaseError)).call(this, message));
...
var ExchangeError = function (_BaseError) {
    ...
    function ExchangeError(message) {
        ...
        var _this2 = _possibleConstructorReturn(this, (ExchangeError.__proto__ || _Object$getPrototypeOf(ExchangeError)).call(this, message));
...
var NotSupported = function (_ExchangeError) {
    ...
    function NotSupported(message) {
        ...
        var _this3 = _possibleConstructorReturn(this, (NotSupported.__proto__ || _Object$getPrototypeOf(NotSupported)).call(this, message));
...
var AuthenticationError = function (_ExchangeError2) {
    ...
    function AuthenticationError(message) {
        ...
        var _this4 = _possibleConstructorReturn(this, (AuthenticationError.__proto__ || _Object$getPrototypeOf(AuthenticationError)).call(this, message));
...
var InvalidNonce = function (_ExchangeError3) {
    ...
    function InvalidNonce(message) {
        ...
        var _this5 = _possibleConstructorReturn(this, (InvalidNonce.__proto__ || _Object$getPrototypeOf(InvalidNonce)).call(this, message));
...
var InsufficientFunds = function (_ExchangeError4) {
    ...
    function InsufficientFunds(message) {
        ...
        var _this6 = _possibleConstructorReturn(this, (InsufficientFunds.__proto__ || _Object$getPrototypeOf(InsufficientFunds)).call(this, message));
...
var InvalidOrder = function (_ExchangeError5) {
    ...
    function InvalidOrder(message) {
        ...
        var _this7 = _possibleConstructorReturn(this, (InvalidOrder.__proto__ || _Object$getPrototypeOf(InvalidOrder)).call(this, message));
...
var OrderNotFound = function (_InvalidOrder) {
    ...
    function OrderNotFound(message) {
        ...
        var _this8 = _possibleConstructorReturn(this, (OrderNotFound.__proto__ || _Object$getPrototypeOf(OrderNotFound)).call(this, message));
...
var OrderNotCached = function (_InvalidOrder2) {
    ...
    function OrderNotCached(message) {
        ...
        var _this9 = _possibleConstructorReturn(this, (OrderNotCached.__proto__ || _Object$getPrototypeOf(OrderNotCached)).call(this, message));
...
var CancelPending = function (_InvalidOrder3) {
    ...
    function CancelPending(message) {
        ...
        var _this10 = _possibleConstructorReturn(this, (CancelPending.__proto__ || _Object$getPrototypeOf(CancelPending)).call(this, message));
...
var NetworkError = function (_BaseError2) {
    ...
    function NetworkError(message) {
        ...
        var _this11 = _possibleConstructorReturn(this, (NetworkError.__proto__ || _Object$getPrototypeOf(NetworkError)).call(this, message));
...
var DDoSProtection = function (_NetworkError) {
    ...
    function DDoSProtection(message) {
        ...
        var _this12 = _possibleConstructorReturn(this, (DDoSProtection.__proto__ || _Object$getPrototypeOf(DDoSProtection)).call(this, message));
...
var RequestTimeout = function (_NetworkError2) {
    ...
    function RequestTimeout(message) {
        ...
        var _this13 = _possibleConstructorReturn(this, (RequestTimeout.__proto__ || _Object$getPrototypeOf(RequestTimeout)).call(this, message));
...
var ExchangeNotAvailable = function (_NetworkError3) {
    ...
    function ExchangeNotAvailable(message) {
        ...
        var _this14 = _possibleConstructorReturn(this, (ExchangeNotAvailable.__proto__ || _Object$getPrototypeOf(ExchangeNotAvailable)).call(this, message));
