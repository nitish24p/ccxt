...
var timeout = function () {
    var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(ms, promise) {
        var clear, timeout;
            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        ...
                        timeout = new _promise2.default(function (resolve) {
                            return clear = setTimeout_safe(resolve, ms);
                        });
                        _context.prev = 2;
                        _context.next = 5;
                        return _promise2.default.race([promise, timeout.then(function () {
...
var deepExtend = function deepExtend() {
    ...
    try {
        for (var _iterator = (0, _getIterator3.default)(args), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            ...
            if (arg && (typeof arg === 'undefined' ? 'undefined' : (0, _typeof3.default)(arg)) == 'object' && (arg.constructor === Object || !('constructor' in arg))) {
    ...
    try {
        for (var _iterator2 = (0, _getIterator3.default)(args), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
            ...
            if (typeof x === 'string') {
                ...
                try {
                    for (var _iterator3 = (0, _getIterator3.default)(x), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                        var k = _step3.value;
...
var groupBy = function groupBy(array, key) {
    var result = {};
    (0, _values2.default)(array).filter(function (entry) {
...
var aggregate = function aggregate(bidasks) {
    ...
    return (0, _keys2.default)(result).map(function (price) {
...
var jwt = function jwt(request, secret) {
    ...
    var encodedHeader = urlencodeBase64(stringToBase64((0, _stringify2.default)({ 'alg': alg, 'typ': 'JWT' }))),
        encodedData = urlencodeBase64(stringToBase64((0, _stringify2.default)(request))),
