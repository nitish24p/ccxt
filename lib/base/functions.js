...
var timeout = function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(ms, promise) {
        var clear, timeout;
            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        ...
                        _context.prev = 2;
                        _context.next = 5;
                        return Promise.race([promise, timeout.then(function () {
...
var groupBy = function groupBy(array, key) {
    var result = {};
    Object.values(array).filter(function (entry) {
...
var aggregate = function aggregate(bidasks) {
    ...
    return Object.keys(result).map(function (price) {
