...
module.exports = function (_Exchange) {
    ...
    function binance() {
        ...
        return _possibleConstructorReturn(this, (binance.__proto__ || Object.getPrototypeOf(binance)).apply(this, arguments));
    }

    _createClass(binance, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend(_get(binance.prototype.__proto__ || Object.getPrototypeOf(binance.prototype), 'describe', this).call(this), {
                'id': 'binance',
                'name': 'Binance',
                'countries': 'CN', // China
                'rateLimit': 500,
        ...
        key: 'request',
        value: function () {
            var _ref16 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee16(path) {
                var api = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'public';
                var method = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'GET';
                var params = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
                var headers = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : undefined;
