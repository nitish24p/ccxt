...
module.exports = function (_Exchange) {
    ...
    function bitbay() {
        ...
        return _possibleConstructorReturn(this, (bitbay.__proto__ || Object.getPrototypeOf(bitbay)).apply(this, arguments));
    }

    _createClass(bitbay, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend(_get(bitbay.prototype.__proto__ || Object.getPrototypeOf(bitbay.prototype), 'describe', this).call(this), {
                'id': 'bitbay',
                'name': 'BitBay',
        ...
        key: 'withdraw',
        value: function () {
            var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(code, amount, address) {
                var params = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
