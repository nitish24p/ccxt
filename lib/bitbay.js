...
module.exports = function (_Exchange) {
    (0, _inherits3.default)(bitbay, _Exchange);

    function bitbay() {
        (0, _classCallCheck3.default)(this, bitbay);
        return (0, _possibleConstructorReturn3.default)(this, (bitbay.__proto__ || (0, _getPrototypeOf2.default)(bitbay)).apply(this, arguments));
    }

    (0, _createClass3.default)(bitbay, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend((0, _get3.default)(bitbay.prototype.__proto__ || (0, _getPrototypeOf2.default)(bitbay.prototype), 'describe', this).call(this), {
                'id': 'bitbay',
                'name': 'BitBay',
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 2:
                                ...
                                result = { 'info': balance };
                                codes = (0, _keys2.default)(this.currencies);
        ...
        key: 'withdraw',
        value: function () {
            var _ref7 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee7(code, amount, address) {
                var params = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
