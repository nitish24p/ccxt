...
module.exports = function (_Exchange) {
    (0, _inherits3.default)(bitfinex, _Exchange);

    function bitfinex() {
        (0, _classCallCheck3.default)(this, bitfinex);
        return (0, _possibleConstructorReturn3.default)(this, (bitfinex.__proto__ || (0, _getPrototypeOf2.default)(bitfinex)).apply(this, arguments));
    }

    (0, _createClass3.default)(bitfinex, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend((0, _get3.default)(bitfinex.prototype.__proto__ || (0, _getPrototypeOf2.default)(bitfinex.prototype), 'describe', this).call(this), {
                'id': 'bitfinex',
                'name': 'Bitfinex',
                'countries': 'VG',
                'version': 'v1',
        ...
        value: function parseOrder(order) {
            ...
            if (exchange) {
                var _order$type$split = order['type'].split(' '),
                    _order$type$split2 = (0, _slicedToArray3.default)(_order$type$split, 2),
        ...
        key: 'fetchOHLCV',
        value: function () {
            var _ref13 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee13(symbol) {
