...
module.exports = function (_bitfinex) {
    (0, _inherits3.default)(bitfinex2, _bitfinex);

    function bitfinex2() {
        (0, _classCallCheck3.default)(this, bitfinex2);
        return (0, _possibleConstructorReturn3.default)(this, (bitfinex2.__proto__ || (0, _getPrototypeOf2.default)(bitfinex2)).apply(this, arguments));
    }

    (0, _createClass3.default)(bitfinex2, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend((0, _get3.default)(bitfinex2.prototype.__proto__ || (0, _getPrototypeOf2.default)(bitfinex2.prototype), 'describe', this).call(this), {
                'id': 'bitfinex2',
                'name': 'Bitfinex v2',
                'countries': 'VG',
                'version': 'v2',
                        ...
                        switch (_context.prev = _context.next) {
                            ...
                            case 2:
                                ...
                                for (b = 0; b < response.length; b++) {
                                    balance = response[b];
                                    _balance = (0, _slicedToArray3.default)(balance, 5), accountType = _balance[0], currency = _balance[1], total = _balance[2], interest = _balance[3], available = _balance[4];
        ...
        value: function parseTrade(trade, market) {
            var _trade = (0, _slicedToArray3.default)(trade, 4),
                id = _trade[0],
                timestamp = _trade[1],
                amount = _trade[2],
                price = _trade[3];
