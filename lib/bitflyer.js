...
module.exports = function (_Exchange) {
    (0, _inherits3.default)(bitflyer, _Exchange);

    function bitflyer() {
        (0, _classCallCheck3.default)(this, bitflyer);
        return (0, _possibleConstructorReturn3.default)(this, (bitflyer.__proto__ || (0, _getPrototypeOf2.default)(bitflyer)).apply(this, arguments));
    }

    (0, _createClass3.default)(bitflyer, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend((0, _get3.default)(bitflyer.prototype.__proto__ || (0, _getPrototypeOf2.default)(bitflyer.prototype), 'describe', this).call(this), {
                'id': 'bitflyer',
                'name': 'bitFlyer',
                'countries': 'JP',
                'version': 'v1',
