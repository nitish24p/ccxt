...
module.exports = function (_Exchange) {
    (0, _inherits3.default)(bithumb, _Exchange);

    function bithumb() {
        (0, _classCallCheck3.default)(this, bithumb);
        return (0, _possibleConstructorReturn3.default)(this, (bithumb.__proto__ || (0, _getPrototypeOf2.default)(bithumb)).apply(this, arguments));
    }

    (0, _createClass3.default)(bithumb, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend((0, _get3.default)(bithumb.prototype.__proto__ || (0, _getPrototypeOf2.default)(bithumb.prototype), 'describe', this).call(this), {
                'id': 'bithumb',
                'name': 'Bithumb',
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 2:
                                ...
                                currencies = (0, _keys2.default)(markets['data']);
                                result = [];
        ...
        value: function parseTrade(trade, market) {
            ...
            var _trade$transaction_da = trade['transaction_date'].split(' '),
                _trade$transaction_da2 = (0, _slicedToArray3.default)(_trade$transaction_da, 2),
