...
module.exports = function (_Exchange) {
    ...
    function bithumb() {
        ...
        return _possibleConstructorReturn(this, (bithumb.__proto__ || Object.getPrototypeOf(bithumb)).apply(this, arguments));
    }

    _createClass(bithumb, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend(_get(bithumb.prototype.__proto__ || Object.getPrototypeOf(bithumb.prototype), 'describe', this).call(this), {
                'id': 'bithumb',
                'name': 'Bithumb',
