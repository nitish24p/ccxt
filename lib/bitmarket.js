...
module.exports = function (_Exchange) {
    ...
    function bitmarket() {
        ...
        return _possibleConstructorReturn(this, (bitmarket.__proto__ || Object.getPrototypeOf(bitmarket)).apply(this, arguments));
    }

    _createClass(bitmarket, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend(_get(bitmarket.prototype.__proto__ || Object.getPrototypeOf(bitmarket.prototype), 'describe', this).call(this), {
                'id': 'bitmarket',
                'name': 'BitMarket',
                'countries': ['PL', 'EU'],
                'rateLimit': 1500,
