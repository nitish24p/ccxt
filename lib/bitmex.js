...
module.exports = function (_Exchange) {
    ...
    function bitmex() {
        ...
        return _possibleConstructorReturn(this, (bitmex.__proto__ || Object.getPrototypeOf(bitmex)).apply(this, arguments));
    }

    _createClass(bitmex, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend(_get(bitmex.prototype.__proto__ || Object.getPrototypeOf(bitmex.prototype), 'describe', this).call(this), {
                'id': 'bitmex',
                'name': 'BitMEX',
