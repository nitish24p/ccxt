...
module.exports = function (_Exchange) {
    (0, _inherits3.default)(bitmex, _Exchange);

    function bitmex() {
        (0, _classCallCheck3.default)(this, bitmex);
        return (0, _possibleConstructorReturn3.default)(this, (bitmex.__proto__ || (0, _getPrototypeOf2.default)(bitmex)).apply(this, arguments));
    }

    (0, _createClass3.default)(bitmex, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend((0, _get3.default)(bitmex.prototype.__proto__ || (0, _getPrototypeOf2.default)(bitmex.prototype), 'describe', this).call(this), {
                'id': 'bitmex',
                'name': 'BitMEX',
        ...
        value: function sign(path) {
            ...
            if ((0, _keys2.default)(params).length) query += '?' + this.urlencode(params);
