...
module.exports = function (_Exchange) {
    ...
    function bitso() {
        ...
        return _possibleConstructorReturn(this, (bitso.__proto__ || Object.getPrototypeOf(bitso)).apply(this, arguments));
    }

    _createClass(bitso, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend(_get(bitso.prototype.__proto__ || Object.getPrototypeOf(bitso.prototype), 'describe', this).call(this), {
                'id': 'bitso',
                'name': 'Bitso',
                'countries': 'MX', // Mexico
