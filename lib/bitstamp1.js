...
module.exports = function (_Exchange) {
    (0, _inherits3.default)(bitstamp1, _Exchange);

    function bitstamp1() {
        (0, _classCallCheck3.default)(this, bitstamp1);
        return (0, _possibleConstructorReturn3.default)(this, (bitstamp1.__proto__ || (0, _getPrototypeOf2.default)(bitstamp1)).apply(this, arguments));
    }

    (0, _createClass3.default)(bitstamp1, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend((0, _get3.default)(bitstamp1.prototype.__proto__ || (0, _getPrototypeOf2.default)(bitstamp1.prototype), 'describe', this).call(this), {
                'id': 'bitstamp1',
                'name': 'Bitstamp v1',
                'countries': 'GB',
                'rateLimit': 1000,
