...
module.exports = function (_Exchange) {
    (0, _inherits3.default)(bittrex, _Exchange);

    function bittrex() {
        (0, _classCallCheck3.default)(this, bittrex);
        return (0, _possibleConstructorReturn3.default)(this, (bittrex.__proto__ || (0, _getPrototypeOf2.default)(bittrex)).apply(this, arguments));
    }

    (0, _createClass3.default)(bittrex, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend((0, _get3.default)(bittrex.prototype.__proto__ || (0, _getPrototypeOf2.default)(bittrex.prototype), 'describe', this).call(this), {
                'id': 'bittrex',
                'name': 'Bittrex',
                'countries': 'US',
                'version': 'v1.1',
                            ...
                            case 4:
                                ...
                                for (t = 0; t < tickers.length; t++) {
                                    ...
                                    if (id in this.markets_by_id) {
                                        ...
                                        _id$split = id.split('-'), _id$split2 = (0, _slicedToArray3.default)(_id$split, 2), quote = _id$split2[0], base = _id$split2[1];
        ...
        key: 'createOrder',
        value: function () {
            var _ref10 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee10(symbol, type, side, amount) {
