...
module.exports = function (_Exchange) {
    (0, _inherits3.default)(btcchina, _Exchange);

    function btcchina() {
        (0, _classCallCheck3.default)(this, btcchina);
        return (0, _possibleConstructorReturn3.default)(this, (btcchina.__proto__ || (0, _getPrototypeOf2.default)(btcchina)).apply(this, arguments));
    }

    (0, _createClass3.default)(btcchina, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend((0, _get3.default)(btcchina.prototype.__proto__ || (0, _getPrototypeOf2.default)(btcchina.prototype), 'describe', this).call(this), {
                'id': 'btcchina',
                'name': 'BTCChina',
                'countries': 'CN',
                'rateLimit': 1500,
