...
module.exports = function (_Exchange) {
    ...
    function btcchina() {
        ...
        return _possibleConstructorReturn(this, (btcchina.__proto__ || Object.getPrototypeOf(btcchina)).apply(this, arguments));
    }

    _createClass(btcchina, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend(_get(btcchina.prototype.__proto__ || Object.getPrototypeOf(btcchina.prototype), 'describe', this).call(this), {
                'id': 'btcchina',
                'name': 'BTCChina',
                'countries': 'CN',
                'rateLimit': 1500,
