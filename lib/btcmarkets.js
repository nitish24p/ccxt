...
module.exports = function (_Exchange) {
    (0, _inherits3.default)(btcmarkets, _Exchange);

    function btcmarkets() {
        (0, _classCallCheck3.default)(this, btcmarkets);
        return (0, _possibleConstructorReturn3.default)(this, (btcmarkets.__proto__ || (0, _getPrototypeOf2.default)(btcmarkets)).apply(this, arguments));
    }

    (0, _createClass3.default)(btcmarkets, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend((0, _get3.default)(btcmarkets.prototype.__proto__ || (0, _getPrototypeOf2.default)(btcmarkets.prototype), 'describe', this).call(this), {
                'id': 'btcmarkets',
                'name': 'BTC Markets',
