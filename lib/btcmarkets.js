...
module.exports = function (_Exchange) {
    ...
    function btcmarkets() {
        ...
        return _possibleConstructorReturn(this, (btcmarkets.__proto__ || Object.getPrototypeOf(btcmarkets)).apply(this, arguments));
    }

    _createClass(btcmarkets, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend(_get(btcmarkets.prototype.__proto__ || Object.getPrototypeOf(btcmarkets.prototype), 'describe', this).call(this), {
                'id': 'btcmarkets',
                'name': 'BTC Markets',
