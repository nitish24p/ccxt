...
module.exports = function (_Exchange) {
    (0, _inherits3.default)(btctradeua, _Exchange);

    function btctradeua() {
        (0, _classCallCheck3.default)(this, btctradeua);
        return (0, _possibleConstructorReturn3.default)(this, (btctradeua.__proto__ || (0, _getPrototypeOf2.default)(btctradeua)).apply(this, arguments));
    }

    (0, _createClass3.default)(btctradeua, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend((0, _get3.default)(btctradeua.prototype.__proto__ || (0, _getPrototypeOf2.default)(btctradeua.prototype), 'describe', this).call(this), {
                'id': 'btctradeua',
                'name': 'BTC Trade UA',
