...
module.exports = function (_Exchange) {
    (0, _inherits3.default)(btcturk, _Exchange);

    function btcturk() {
        (0, _classCallCheck3.default)(this, btcturk);
        return (0, _possibleConstructorReturn3.default)(this, (btcturk.__proto__ || (0, _getPrototypeOf2.default)(btcturk)).apply(this, arguments));
    }

    (0, _createClass3.default)(btcturk, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend((0, _get3.default)(btcturk.prototype.__proto__ || (0, _getPrototypeOf2.default)(btcturk.prototype), 'describe', this).call(this), {
                'id': 'btcturk',
                'name': 'BTCTurk',
                'countries': 'TR', // Turkey
                'rateLimit': 1000,
