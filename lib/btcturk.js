...
module.exports = function (_Exchange) {
    ...
    function btcturk() {
        ...
        return _possibleConstructorReturn(this, (btcturk.__proto__ || Object.getPrototypeOf(btcturk)).apply(this, arguments));
    }

    _createClass(btcturk, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend(_get(btcturk.prototype.__proto__ || Object.getPrototypeOf(btcturk.prototype), 'describe', this).call(this), {
                'id': 'btcturk',
                'name': 'BTCTurk',
                'countries': 'TR', // Turkey
                'rateLimit': 1000,
