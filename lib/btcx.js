...
module.exports = function (_Exchange) {
    ...
    function btcx() {
        ...
        return _possibleConstructorReturn(this, (btcx.__proto__ || Object.getPrototypeOf(btcx)).apply(this, arguments));
    }

    _createClass(btcx, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend(_get(btcx.prototype.__proto__ || Object.getPrototypeOf(btcx.prototype), 'describe', this).call(this), {
                'id': 'btcx',
                'name': 'BTCX',
                'countries': ['IS', 'US', 'EU'],
