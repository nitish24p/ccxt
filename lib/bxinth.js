...
module.exports = function (_Exchange) {
    (0, _inherits3.default)(bxinth, _Exchange);

    function bxinth() {
        (0, _classCallCheck3.default)(this, bxinth);
        return (0, _possibleConstructorReturn3.default)(this, (bxinth.__proto__ || (0, _getPrototypeOf2.default)(bxinth)).apply(this, arguments));
    }

    (0, _createClass3.default)(bxinth, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend((0, _get3.default)(bxinth.prototype.__proto__ || (0, _getPrototypeOf2.default)(bxinth.prototype), 'describe', this).call(this), {
                'id': 'bxinth',
                'name': 'BX.in.th',
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            ...
                            case 4:
                                ...
                                result = { 'info': balance };
                                currencies = (0, _keys2.default)(balance);
