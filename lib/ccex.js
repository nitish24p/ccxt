...
module.exports = function (_Exchange) {
    ...
    function ccex() {
        ...
        return _possibleConstructorReturn(this, (ccex.__proto__ || Object.getPrototypeOf(ccex)).apply(this, arguments));
    }

    _createClass(ccex, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend(_get(ccex.prototype.__proto__ || Object.getPrototypeOf(ccex.prototype), 'describe', this).call(this), {
                'id': 'ccex',
                'name': 'C-CEX',
                'countries': ['DE', 'EU'],
                'rateLimit': 1500,
