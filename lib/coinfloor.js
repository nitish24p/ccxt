...
module.exports = function (_Exchange) {
    (0, _inherits3.default)(coinfloor, _Exchange);

    function coinfloor() {
        (0, _classCallCheck3.default)(this, coinfloor);
        return (0, _possibleConstructorReturn3.default)(this, (coinfloor.__proto__ || (0, _getPrototypeOf2.default)(coinfloor)).apply(this, arguments));
    }

    (0, _createClass3.default)(coinfloor, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend((0, _get3.default)(coinfloor.prototype.__proto__ || (0, _getPrototypeOf2.default)(coinfloor.prototype), 'describe', this).call(this), {
                'id': 'coinfloor',
                'name': 'coinfloor',
                'rateLimit': 1000,
                'countries': 'UK',
