...
module.exports = function (_Exchange) {
    ...
    function coinfloor() {
        ...
        return _possibleConstructorReturn(this, (coinfloor.__proto__ || Object.getPrototypeOf(coinfloor)).apply(this, arguments));
    }

    _createClass(coinfloor, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend(_get(coinfloor.prototype.__proto__ || Object.getPrototypeOf(coinfloor.prototype), 'describe', this).call(this), {
                'id': 'coinfloor',
                'name': 'coinfloor',
                'rateLimit': 1000,
                'countries': 'UK',
