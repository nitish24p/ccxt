...
module.exports = function (_Exchange) {
    (0, _inherits3.default)(coingi, _Exchange);

    function coingi() {
        (0, _classCallCheck3.default)(this, coingi);
        return (0, _possibleConstructorReturn3.default)(this, (coingi.__proto__ || (0, _getPrototypeOf2.default)(coingi)).apply(this, arguments));
    }

    (0, _createClass3.default)(coingi, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend((0, _get3.default)(coingi.prototype.__proto__ || (0, _getPrototypeOf2.default)(coingi.prototype), 'describe', this).call(this), {
                'id': 'coingi',
                'name': 'Coingi',
                'rateLimit': 1000,
