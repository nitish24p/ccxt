...
module.exports = function (_Exchange) {
    ...
    function coingi() {
        ...
        return _possibleConstructorReturn(this, (coingi.__proto__ || Object.getPrototypeOf(coingi)).apply(this, arguments));
    }

    _createClass(coingi, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend(_get(coingi.prototype.__proto__ || Object.getPrototypeOf(coingi.prototype), 'describe', this).call(this), {
                'id': 'coingi',
                'name': 'Coingi',
                'rateLimit': 1000,
