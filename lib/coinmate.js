...
module.exports = function (_Exchange) {
    (0, _inherits3.default)(coinmate, _Exchange);

    function coinmate() {
        (0, _classCallCheck3.default)(this, coinmate);
        return (0, _possibleConstructorReturn3.default)(this, (coinmate.__proto__ || (0, _getPrototypeOf2.default)(coinmate)).apply(this, arguments));
    }

    (0, _createClass3.default)(coinmate, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend((0, _get3.default)(coinmate.prototype.__proto__ || (0, _getPrototypeOf2.default)(coinmate.prototype), 'describe', this).call(this), {
                'id': 'coinmate',
                'name': 'CoinMate',
