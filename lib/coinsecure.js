...
module.exports = function (_Exchange) {
    (0, _inherits3.default)(coinsecure, _Exchange);

    function coinsecure() {
        (0, _classCallCheck3.default)(this, coinsecure);
        return (0, _possibleConstructorReturn3.default)(this, (coinsecure.__proto__ || (0, _getPrototypeOf2.default)(coinsecure)).apply(this, arguments));
    }

    (0, _createClass3.default)(coinsecure, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend((0, _get3.default)(coinsecure.prototype.__proto__ || (0, _getPrototypeOf2.default)(coinsecure.prototype), 'describe', this).call(this), {
                'id': 'coinsecure',
                'name': 'Coinsecure',
                'countries': 'IN', // India
                'rateLimit': 1000,
        ...
        key: 'createOrder',
        value: function () {
            var _ref4 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4(market, type, side, amount) {
