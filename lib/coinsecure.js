...
module.exports = function (_Exchange) {
    ...
    function coinsecure() {
        ...
        return _possibleConstructorReturn(this, (coinsecure.__proto__ || Object.getPrototypeOf(coinsecure)).apply(this, arguments));
    }

    _createClass(coinsecure, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend(_get(coinsecure.prototype.__proto__ || Object.getPrototypeOf(coinsecure.prototype), 'describe', this).call(this), {
                'id': 'coinsecure',
                'name': 'Coinsecure',
                'countries': 'IN', // India
                'rateLimit': 1000,
        ...
        key: 'createOrder',
        value: function () {
            var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(market, type, side, amount) {
