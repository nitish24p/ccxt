...
module.exports = function (_Exchange) {
    ...
    function coinspot() {
        ...
        return _possibleConstructorReturn(this, (coinspot.__proto__ || Object.getPrototypeOf(coinspot)).apply(this, arguments));
    }

    _createClass(coinspot, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend(_get(coinspot.prototype.__proto__ || Object.getPrototypeOf(coinspot.prototype), 'describe', this).call(this), {
                'id': 'coinspot',
                'name': 'CoinSpot',
