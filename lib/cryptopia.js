...
module.exports = function (_Exchange) {
    ...
    function cryptopia() {
        ...
        return _possibleConstructorReturn(this, (cryptopia.__proto__ || Object.getPrototypeOf(cryptopia)).apply(this, arguments));
    }

    _createClass(cryptopia, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend(_get(cryptopia.prototype.__proto__ || Object.getPrototypeOf(cryptopia.prototype), 'describe', this).call(this), {
                'id': 'cryptopia',
                'name': 'Cryptopia',
                'rateLimit': 1500,
