...
module.exports = function (_Exchange) {
    (0, _inherits3.default)(flowbtc, _Exchange);

    function flowbtc() {
        (0, _classCallCheck3.default)(this, flowbtc);
        return (0, _possibleConstructorReturn3.default)(this, (flowbtc.__proto__ || (0, _getPrototypeOf2.default)(flowbtc)).apply(this, arguments));
    }

    (0, _createClass3.default)(flowbtc, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend((0, _get3.default)(flowbtc.prototype.__proto__ || (0, _getPrototypeOf2.default)(flowbtc.prototype), 'describe', this).call(this), {
                'id': 'flowbtc',
                'name': 'flowBTC',
                'countries': 'BR', // Brazil
                'version': 'v1',
