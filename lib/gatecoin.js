...
module.exports = function (_Exchange) {
    (0, _inherits3.default)(gatecoin, _Exchange);

    function gatecoin() {
        (0, _classCallCheck3.default)(this, gatecoin);
        return (0, _possibleConstructorReturn3.default)(this, (gatecoin.__proto__ || (0, _getPrototypeOf2.default)(gatecoin)).apply(this, arguments));
    }

    (0, _createClass3.default)(gatecoin, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend((0, _get3.default)(gatecoin.prototype.__proto__ || (0, _getPrototypeOf2.default)(gatecoin.prototype), 'describe', this).call(this), {
                'id': 'gatecoin',
                'name': 'Gatecoin',
                'rateLimit': 2000,
