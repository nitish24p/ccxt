...
module.exports = function (_Exchange) {
    (0, _inherits3.default)(gdax, _Exchange);

    function gdax() {
        (0, _classCallCheck3.default)(this, gdax);
        return (0, _possibleConstructorReturn3.default)(this, (gdax.__proto__ || (0, _getPrototypeOf2.default)(gdax)).apply(this, arguments));
    }

    (0, _createClass3.default)(gdax, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend((0, _get3.default)(gdax.prototype.__proto__ || (0, _getPrototypeOf2.default)(gdax.prototype), 'describe', this).call(this), {
                'id': 'gdax',
                'name': 'GDAX',
                'countries': 'US',
                'rateLimit': 1000,
                        ...
                        switch (_context.prev = _context.next) {
                            ...
                            case 2:
                                ...
                                for (p = 0; p < markets.length; p++) {
                                    ...
                                    precision = {
                                        'amount': -(0, _log2.default)(parseFloat(amountLimits['min'])),
                                        'price': -(0, _log2.default)(parseFloat(priceLimits['min']))
                                    };
        ...
        key: 'createOrder',
        value: function () {
            var _ref12 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee12(market, type, side, amount) {
        ...
        value: function sign(path) {
            ...
            if (method == 'GET') {
                if ((0, _keys2.default)(query).length) request += '?' + this.urlencode(query);
            }
