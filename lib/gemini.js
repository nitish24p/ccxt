...
module.exports = function (_Exchange) {
    ...
    function gemini() {
        ...
        return _possibleConstructorReturn(this, (gemini.__proto__ || Object.getPrototypeOf(gemini)).apply(this, arguments));
    }

    _createClass(gemini, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend(_get(gemini.prototype.__proto__ || Object.getPrototypeOf(gemini.prototype), 'describe', this).call(this), {
                'id': 'gemini',
                'name': 'Gemini',
                'countries': 'US',
