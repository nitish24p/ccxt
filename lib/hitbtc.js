...
module.exports = function (_Exchange) {
    ...
    function hitbtc() {
        ...
        return _possibleConstructorReturn(this, (hitbtc.__proto__ || Object.getPrototypeOf(hitbtc)).apply(this, arguments));
    }

    _createClass(hitbtc, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend(_get(hitbtc.prototype.__proto__ || Object.getPrototypeOf(hitbtc.prototype), 'describe', this).call(this), {
                'id': 'hitbtc',
                'name': 'HitBTC',
        ...
        value: function () {
            var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
                var markets, result, p, market, id, base, quote, lot, _step, symbol;
        ...
        key: 'withdraw',
        value: function () {
            var _ref12 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee12(currency, amount, address) {
                var params = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
                var response;
