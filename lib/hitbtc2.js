...
module.exports = function (_hitbtc) {
    (0, _inherits3.default)(hitbtc2, _hitbtc);

    function hitbtc2() {
        (0, _classCallCheck3.default)(this, hitbtc2);
        return (0, _possibleConstructorReturn3.default)(this, (hitbtc2.__proto__ || (0, _getPrototypeOf2.default)(hitbtc2)).apply(this, arguments));
    }

    (0, _createClass3.default)(hitbtc2, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend((0, _get3.default)(hitbtc2.prototype.__proto__ || (0, _getPrototypeOf2.default)(hitbtc2.prototype), 'describe', this).call(this), {
                'id': 'hitbtc2',
                'name': 'HitBTC v2',
        ...
        value: function () {
            var _ref16 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee16(currency) {
                var params = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
        ...
        value: function () {
            var _ref17 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee17(currency) {
                var params = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
                var currencyId, response, address;
        ...
        key: 'withdraw',
        value: function () {
            var _ref18 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee18(currency, amount, address) {
                var params = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
        ...
        key: 'request',
        value: function () {
            var _ref19 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee19(path) {
                var api = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'public';
                var method = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'GET';
                var params = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
                var headers = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : undefined;
