...
module.exports = function (_Exchange) {
    (0, _inherits3.default)(huobi, _Exchange);

    function huobi() {
        (0, _classCallCheck3.default)(this, huobi);
        return (0, _possibleConstructorReturn3.default)(this, (huobi.__proto__ || (0, _getPrototypeOf2.default)(huobi)).apply(this, arguments));
    }

    (0, _createClass3.default)(huobi, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend((0, _get3.default)(huobi.prototype.__proto__ || (0, _getPrototypeOf2.default)(huobi.prototype), 'describe', this).call(this), {
                'id': 'huobi',
                'name': 'Huobi',
                'countries': 'CN',
                'rateLimit': 2000,
        ...
        value: function sign(path) {
            ...
            if (api == 'trade') {
                ...
                if ((0, _keys2.default)(_query).length) url += '?' + this.urlencode(_query);
            }
