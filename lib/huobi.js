...
module.exports = function (_Exchange) {
    ...
    function huobi() {
        ...
        return _possibleConstructorReturn(this, (huobi.__proto__ || Object.getPrototypeOf(huobi)).apply(this, arguments));
    }

    _createClass(huobi, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend(_get(huobi.prototype.__proto__ || Object.getPrototypeOf(huobi.prototype), 'describe', this).call(this), {
                'id': 'huobi',
                'name': 'Huobi',
                'countries': 'CN',
                'rateLimit': 2000,
