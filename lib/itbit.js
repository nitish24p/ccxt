...
module.exports = function (_Exchange) {
    (0, _inherits3.default)(itbit, _Exchange);

    function itbit() {
        (0, _classCallCheck3.default)(this, itbit);
        return (0, _possibleConstructorReturn3.default)(this, (itbit.__proto__ || (0, _getPrototypeOf2.default)(itbit)).apply(this, arguments));
    }

    (0, _createClass3.default)(itbit, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend((0, _get3.default)(itbit.prototype.__proto__ || (0, _getPrototypeOf2.default)(itbit.prototype), 'describe', this).call(this), {
                'id': 'itbit',
                'name': 'itBit',
                'countries': 'US',
                'rateLimit': 2000,
        ...
        value: function sign(path) {
            ...
            if (api == 'public') {
                ...
                if ((0, _keys2.default)(query).length) body = this.json(query);else body = '';
