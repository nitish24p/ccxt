...
module.exports = function (_Exchange) {
    ...
    function itbit() {
        ...
        return _possibleConstructorReturn(this, (itbit.__proto__ || Object.getPrototypeOf(itbit)).apply(this, arguments));
    }

    _createClass(itbit, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend(_get(itbit.prototype.__proto__ || Object.getPrototypeOf(itbit.prototype), 'describe', this).call(this), {
                'id': 'itbit',
                'name': 'itBit',
                'countries': 'US',
                'rateLimit': 2000,
