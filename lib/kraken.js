...
module.exports = function (_Exchange) {
    (0, _inherits3.default)(kraken, _Exchange);

    function kraken() {
        (0, _classCallCheck3.default)(this, kraken);
        return (0, _possibleConstructorReturn3.default)(this, (kraken.__proto__ || (0, _getPrototypeOf2.default)(kraken)).apply(this, arguments));
    }

    (0, _createClass3.default)(kraken, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend((0, _get3.default)(kraken.prototype.__proto__ || (0, _getPrototypeOf2.default)(kraken.prototype), 'describe', this).call(this), {
                'id': 'kraken',
                'name': 'Kraken',
                'countries': 'US',
                'version': '0',
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 2:
                                ...
                                keys = (0, _keys2.default)(markets['result']);
                                result = [];
        ...
        value: function () {
            var _ref17 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee17(code) {
                var params = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
