...
module.exports = function (_Exchange) {
    ...
    function kucoin() {
        ...
        return _possibleConstructorReturn(this, (kucoin.__proto__ || Object.getPrototypeOf(kucoin)).apply(this, arguments));
    }

    _createClass(kucoin, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend(_get(kucoin.prototype.__proto__ || Object.getPrototypeOf(kucoin.prototype), 'describe', this).call(this), {
                'id': 'kucoin',
                'name': 'Kucoin',
        ...
        key: 'fetchTicker',
        value: function () {
            var _ref10 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10(symbol) {
                var params = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
        ...
        key: 'fetchTrades',
        value: function () {
            var _ref11 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee11(symbol) {
                var since = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : undefined;
                var limit = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : undefined;
                var params = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
                var market, response;
        ...
        key: 'fetchOHLCV',
        value: function () {
            var _ref12 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee12(symbol) {
        ...
        key: 'request',
        value: function () {
            var _ref13 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee13(path) {
                var api = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'public';
                var method = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'GET';
                var params = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
                var headers = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : undefined;
