...
module.exports = function (_acx) {
    ...
    function kuna() {
        ...
        return _possibleConstructorReturn(this, (kuna.__proto__ || Object.getPrototypeOf(kuna)).apply(this, arguments));
    }

    _createClass(kuna, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend(_get(kuna.prototype.__proto__ || Object.getPrototypeOf(kuna.prototype), 'describe', this).call(this), {
                'id': 'kuna',
                'name': 'Kuna',
                'countries': 'UA',
                'rateLimit': 1000,
        ...
        value: function () {
            var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(symbol, params) {
