...
module.exports = function (_Exchange) {
    (0, _inherits3.default)(livecoin, _Exchange);

    function livecoin() {
        (0, _classCallCheck3.default)(this, livecoin);
        return (0, _possibleConstructorReturn3.default)(this, (livecoin.__proto__ || (0, _getPrototypeOf2.default)(livecoin)).apply(this, arguments));
    }

    (0, _createClass3.default)(livecoin, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend((0, _get3.default)(livecoin.prototype.__proto__ || (0, _getPrototypeOf2.default)(livecoin.prototype), 'describe', this).call(this), {
                'id': 'livecoin',
                'name': 'LiveCoin',
                'countries': ['US', 'UK', 'RU'],
                'rateLimit': 1000,
        ...
        value: function parseOrder(order) {
            ...
            var _symbol$split3 = symbol.split('/'),
                _symbol$split4 = (0, _slicedToArray3.default)(_symbol$split3, 2),
        ...
        key: 'createOrder',
        value: function () {
            var _ref12 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee12(symbol, type, side, amount) {
