...
module.exports = function (_Exchange) {
    (0, _inherits3.default)(luno, _Exchange);

    function luno() {
        (0, _classCallCheck3.default)(this, luno);
        return (0, _possibleConstructorReturn3.default)(this, (luno.__proto__ || (0, _getPrototypeOf2.default)(luno)).apply(this, arguments));
    }

    (0, _createClass3.default)(luno, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend((0, _get3.default)(luno.prototype.__proto__ || (0, _getPrototypeOf2.default)(luno.prototype), 'describe', this).call(this), {
                'id': 'luno',
                'name': 'luno',
                'countries': ['GB', 'SG', 'ZA'],
                'rateLimit': 10000,
        ...
        key: 'createOrder',
        value: function () {
            var _ref8 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee8(market, type, side, amount) {
