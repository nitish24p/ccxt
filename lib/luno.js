...
module.exports = function (_Exchange) {
    ...
    function luno() {
        ...
        return _possibleConstructorReturn(this, (luno.__proto__ || Object.getPrototypeOf(luno)).apply(this, arguments));
    }

    _createClass(luno, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend(_get(luno.prototype.__proto__ || Object.getPrototypeOf(luno.prototype), 'describe', this).call(this), {
                'id': 'luno',
                'name': 'luno',
                'countries': ['GB', 'SG', 'ZA'],
                'rateLimit': 10000,
        ...
        key: 'createOrder',
        value: function () {
            var _ref8 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(market, type, side, amount) {
