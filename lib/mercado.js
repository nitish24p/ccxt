...
module.exports = function (_Exchange) {
    (0, _inherits3.default)(mercado, _Exchange);

    function mercado() {
        (0, _classCallCheck3.default)(this, mercado);
        return (0, _possibleConstructorReturn3.default)(this, (mercado.__proto__ || (0, _getPrototypeOf2.default)(mercado)).apply(this, arguments));
    }

    (0, _createClass3.default)(mercado, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend((0, _get3.default)(mercado.prototype.__proto__ || (0, _getPrototypeOf2.default)(mercado.prototype), 'describe', this).call(this), {
                'id': 'mercado',
