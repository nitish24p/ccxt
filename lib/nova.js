...
module.exports = function (_Exchange) {
    (0, _inherits3.default)(nova, _Exchange);

    function nova() {
        (0, _classCallCheck3.default)(this, nova);
        return (0, _possibleConstructorReturn3.default)(this, (nova.__proto__ || (0, _getPrototypeOf2.default)(nova)).apply(this, arguments));
    }

    (0, _createClass3.default)(nova, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend((0, _get3.default)(nova.prototype.__proto__ || (0, _getPrototypeOf2.default)(nova.prototype), 'describe', this).call(this), {
                'id': 'nova',
                'name': 'Novaexchange',
