...
module.exports = function (_Exchange) {
    ...
    function nova() {
        ...
        return _possibleConstructorReturn(this, (nova.__proto__ || Object.getPrototypeOf(nova)).apply(this, arguments));
    }

    _createClass(nova, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend(_get(nova.prototype.__proto__ || Object.getPrototypeOf(nova.prototype), 'describe', this).call(this), {
                'id': 'nova',
                'name': 'Novaexchange',
