...
module.exports = function (_Exchange) {
    (0, _inherits3.default)(okcoinusd, _Exchange);

    function okcoinusd() {
        (0, _classCallCheck3.default)(this, okcoinusd);
        return (0, _possibleConstructorReturn3.default)(this, (okcoinusd.__proto__ || (0, _getPrototypeOf2.default)(okcoinusd)).apply(this, arguments));
    }

    (0, _createClass3.default)(okcoinusd, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend((0, _get3.default)(okcoinusd.prototype.__proto__ || (0, _getPrototypeOf2.default)(okcoinusd.prototype), 'describe', this).call(this), {
                'id': 'okcoinusd',
                'name': 'OKCoin USD',
                'countries': ['CN', 'US'],
                'hasCORS': false,
                        ...
                        switch (_context.prev = _context.next) {
                            ...
                            case 2:
                                ...
                                for (i = 0; i < markets.length; i++) {
                                    ...
                                    _uppercase$split = uppercase.split('_'), _uppercase$split2 = (0, _slicedToArray3.default)(_uppercase$split, 2), base = _uppercase$split2[0], quote = _uppercase$split2[1];
                                    symbol = base + '/' + quote;
                                    precision = {
        ...
        key: 'withdraw',
        value: function () {
            var _ref13 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee13(currency, amount, address) {
                var params = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
        ...
        key: 'request',
        value: function () {
            var _ref14 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee14(path) {
                var api = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'public';
                var method = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'GET';
                var params = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
                var headers = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : undefined;
