...
module.exports = function (_Exchange) {
    (0, _inherits3.default)(qryptos, _Exchange);

    function qryptos() {
        (0, _classCallCheck3.default)(this, qryptos);
        return (0, _possibleConstructorReturn3.default)(this, (qryptos.__proto__ || (0, _getPrototypeOf2.default)(qryptos)).apply(this, arguments));
    }

    (0, _createClass3.default)(qryptos, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend((0, _get3.default)(qryptos.prototype.__proto__ || (0, _getPrototypeOf2.default)(qryptos.prototype), 'describe', this).call(this), {
                'id': 'qryptos',
                'name': 'QRYPTOS',
                'countries': ['CN', 'TW'],
                'version': '2',
        ...
        value: function sign(path) {
            ...
            if (api == 'public') {
                ...
                if (method == 'GET') {
                    if ((0, _keys2.default)(query).length) url += '?' + this.urlencode(query);
                } else if ((0, _keys2.default)(query).length) {
