...
module.exports = function (_Exchange) {
    (0, _inherits3.default)(quadrigacx, _Exchange);

    function quadrigacx() {
        (0, _classCallCheck3.default)(this, quadrigacx);
        return (0, _possibleConstructorReturn3.default)(this, (quadrigacx.__proto__ || (0, _getPrototypeOf2.default)(quadrigacx)).apply(this, arguments));
    }

    (0, _createClass3.default)(quadrigacx, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend((0, _get3.default)(quadrigacx.prototype.__proto__ || (0, _getPrototypeOf2.default)(quadrigacx.prototype), 'describe', this).call(this), {
                'id': 'quadrigacx',
                'name': 'QuadrigaCX',
                'countries': 'CA',
                'rateLimit': 1000,
        ...
        value: function () {
            var _ref7 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee7(currency) {
                var params = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
