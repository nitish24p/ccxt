...
module.exports = function (_Exchange) {
    ...
    function southxchange() {
        ...
        return _possibleConstructorReturn(this, (southxchange.__proto__ || Object.getPrototypeOf(southxchange)).apply(this, arguments));
    }

    _createClass(southxchange, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend(_get(southxchange.prototype.__proto__ || Object.getPrototypeOf(southxchange.prototype), 'describe', this).call(this), {
                'id': 'southxchange',
                'name': 'SouthXchange',
