...
module.exports = function (_Exchange) {
    (0, _inherits3.default)(southxchange, _Exchange);

    function southxchange() {
        (0, _classCallCheck3.default)(this, southxchange);
        return (0, _possibleConstructorReturn3.default)(this, (southxchange.__proto__ || (0, _getPrototypeOf2.default)(southxchange)).apply(this, arguments));
    }

    (0, _createClass3.default)(southxchange, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend((0, _get3.default)(southxchange.prototype.__proto__ || (0, _getPrototypeOf2.default)(southxchange.prototype), 'describe', this).call(this), {
                'id': 'southxchange',
                'name': 'SouthXchange',
