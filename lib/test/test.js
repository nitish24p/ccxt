...
let testTicker = (() => {
    var _ref = _asyncToGenerator(function* (exchange, symbol) {
...
let testOrderBook = (() => {
    var _ref2 = _asyncToGenerator(function* (exchange, symbol) {
...
let testTrades = (() => {
    var _ref3 = _asyncToGenerator(function* (exchange, symbol) {
...
let testTickers = (() => {
    var _ref4 = _asyncToGenerator(function* (exchange, symbol) {
...
let testOHLCV = (() => {
    var _ref5 = _asyncToGenerator(function* (exchange, symbol) {
...
let testSymbol = (() => {
    var _ref6 = _asyncToGenerator(function* (exchange, symbol) {
...
let testOrders = (() => {
    var _ref7 = _asyncToGenerator(function* (exchange, symbol) {
...
let testClosedOrders = (() => {
    var _ref8 = _asyncToGenerator(function* (exchange, symbol) {
...
let testOpenOrders = (() => {
    var _ref9 = _asyncToGenerator(function* (exchange, symbol) {
...
let testMyTrades = (() => {
    var _ref10 = _asyncToGenerator(function* (exchange, symbol) {
...
let testFetchCurrencies = (() => {
    var _ref11 = _asyncToGenerator(function* (exchange, symbol) {
...
let testBalance = (() => {
    var _ref12 = _asyncToGenerator(function* (exchange, symbol) {
...
let loadExchange = (() => {
    var _ref13 = _asyncToGenerator(function* (exchange) {
...
let testExchange = (() => {
    var _ref14 = _asyncToGenerator(function* (exchange) {
...
let printExchangesTable = function () {
    ...
    console.log(astable(_Object$values(exchanges).map(exchange => {
...
let tryAllProxies = (() => {
    var _ref15 = _asyncToGenerator(function* (exchange, proxies) {
