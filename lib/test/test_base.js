...
describe('ccxt base code', function () {
    ...
    it('safeFloat is robust', (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
    ...
    it('timeout() is working', (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2() {
            ...
            while (1) {
                switch (_context2.prev = _context2.next) {
                    case 0:
                        _context2.t0 = assert;
                        _context2.next = 3;
                        return ccxt.timeout(200, new _promise2.default(function (resolve) {
                    ...
                    case 3:
                        ...
                        _context2.next = 7;
                        return ccxt.timeout(100, _promise2.default.reject('foo')).should.be.rejectedWith('foo');

                    case 7:
                        _context2.next = 9;
                        return ccxt.timeout(100, new _promise2.default(function (resolve, reject) {
                            return setTimeout(function () {
                                return reject('foo');
                            }, 200);
    ...
    it('calculateFee() works', function () {
        ...
        (0, _keys2.default)(fees).forEach(function (takerOrMaker) {
    ...
    it.skip('rate limiting works', (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee5() {
        ...
        return _regenerator2.default.wrap(function _callee5$(_context5) {
            while (1) {
                switch (_context5.prev = _context5.next) {
                                            ...
                                            switch (_context3.prev = _context3.next) {
                                                case 0:
                                                    return _context3.abrupt('return', this.throttle().then(function () {
                                                        return exchange.pong.apply(exchange, (0, _toConsumableArray3.default)(args));
                                                    }));
                    ...
                    case 13:
                        _context5.next = 15;
                        return _promise2.default.all([exchange.ping('qux'), exchange.ping('zap'), exchange.ping('lol')]);
