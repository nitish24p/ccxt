...
describe('ccxt base code', () => {
    ...
    it('timeout() is working', _asyncToGenerator(function* () {
        ...
        assert('foo', (yield ccxt.timeout(200, new Promise(function (resolve) {
            return setTimeout(function () {
                return resolve('foo');
            }, 100);
        }))));

        yield ccxt.timeout(100, Promise.reject('foo')).should.be.rejectedWith('foo');
        yield ccxt.timeout(100, new Promise(function (resolve, reject) {
            return setTimeout(function () {
                return reject('foo');
            }, 200);
    ...
    it.skip('rate limiting works', _asyncToGenerator(function* () {
        ...
        yield Promise.all([exchange.ping('qux'), exchange.ping('zap'), exchange.ping('lol')]);
