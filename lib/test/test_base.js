...
describe('ccxt base code', () => {
    ...
    it('safeFloat is robust', _asyncToGenerator(function* () {
    ...
    it('timeout() is working', _asyncToGenerator(function* () {

        assert('foo', (yield ccxt.timeout(200, new _Promise(function (resolve) {
            return setTimeout(function () {
                return resolve('foo');
            }, 100);
        }))));

        yield ccxt.timeout(100, _Promise.reject('foo')).should.be.rejectedWith('foo');
        yield ccxt.timeout(100, new _Promise(function (resolve, reject) {
            return setTimeout(function () {
                return reject('foo');
            }, 200);
    ...
    it('calculateFee() works', () => {
        ...
        _Object$keys(fees).forEach(takerOrMaker => {
    ...
    it.skip('rate limiting works', _asyncToGenerator(function* () {
        ...
        yield _Promise.all([exchange.ping('qux'), exchange.ping('zap'), exchange.ping('lol')]);
