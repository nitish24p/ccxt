...
module.exports = function (_Exchange) {
    ...
    function therock() {
        ...
        return _possibleConstructorReturn(this, (therock.__proto__ || Object.getPrototypeOf(therock)).apply(this, arguments));
    }

    _createClass(therock, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend(_get(therock.prototype.__proto__ || Object.getPrototypeOf(therock.prototype), 'describe', this).call(this), {
                'id': 'therock',
                'name': 'TheRockTrading',
                'countries': 'MT',
                'rateLimit': 1000,
