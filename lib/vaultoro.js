...
module.exports = function (_Exchange) {
    (0, _inherits3.default)(vaultoro, _Exchange);

    function vaultoro() {
        (0, _classCallCheck3.default)(this, vaultoro);
        return (0, _possibleConstructorReturn3.default)(this, (vaultoro.__proto__ || (0, _getPrototypeOf2.default)(vaultoro)).apply(this, arguments));
    }

    (0, _createClass3.default)(vaultoro, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend((0, _get3.default)(vaultoro.prototype.__proto__ || (0, _getPrototypeOf2.default)(vaultoro.prototype), 'describe', this).call(this), {
                'id': 'vaultoro',
                'name': 'Vaultoro',
                'countries': 'CH',
                'rateLimit': 1000,
