...
module.exports = function (_Exchange) {
    ...
    function virwox() {
        ...
        return _possibleConstructorReturn(this, (virwox.__proto__ || Object.getPrototypeOf(virwox)).apply(this, arguments));
    }

    _createClass(virwox, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend(_get(virwox.prototype.__proto__ || Object.getPrototypeOf(virwox.prototype), 'describe', this).call(this), {
                'id': 'virwox',
                'name': 'VirWoX',
                'countries': ['AT', 'EU'],
                'rateLimit': 1000,
        ...
        key: 'createOrder',
        value: function () {
            var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(market, type, side, amount) {
