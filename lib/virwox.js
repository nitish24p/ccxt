...
module.exports = function (_Exchange) {
    (0, _inherits3.default)(virwox, _Exchange);

    function virwox() {
        (0, _classCallCheck3.default)(this, virwox);
        return (0, _possibleConstructorReturn3.default)(this, (virwox.__proto__ || (0, _getPrototypeOf2.default)(virwox)).apply(this, arguments));
    }

    (0, _createClass3.default)(virwox, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend((0, _get3.default)(virwox.prototype.__proto__ || (0, _getPrototypeOf2.default)(virwox.prototype), 'describe', this).call(this), {
                'id': 'virwox',
                'name': 'VirWoX',
                'countries': ['AT', 'EU'],
                'rateLimit': 1000,
        ...
        key: 'createOrder',
        value: function () {
            var _ref7 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee7(market, type, side, amount) {
