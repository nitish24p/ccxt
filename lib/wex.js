...
module.exports = function (_liqui) {
    (0, _inherits3.default)(wex, _liqui);

    function wex() {
        (0, _classCallCheck3.default)(this, wex);
        return (0, _possibleConstructorReturn3.default)(this, (wex.__proto__ || (0, _getPrototypeOf2.default)(wex)).apply(this, arguments));
    }

    (0, _createClass3.default)(wex, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend((0, _get3.default)(wex.prototype.__proto__ || (0, _getPrototypeOf2.default)(wex.prototype), 'describe', this).call(this), {
                'id': 'wex',
                'name': 'WEX',
