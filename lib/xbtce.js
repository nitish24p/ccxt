...
module.exports = function (_Exchange) {
    ...
    function xbtce() {
        ...
        return _possibleConstructorReturn(this, (xbtce.__proto__ || Object.getPrototypeOf(xbtce)).apply(this, arguments));
    }

    _createClass(xbtce, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend(_get(xbtce.prototype.__proto__ || Object.getPrototypeOf(xbtce.prototype), 'describe', this).call(this), {
                'id': 'xbtce',
                'name': 'xBTCe',
                'countries': 'RU',
