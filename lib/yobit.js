...
module.exports = function (_liqui) {
    ...
    function yobit() {
        ...
        return _possibleConstructorReturn(this, (yobit.__proto__ || Object.getPrototypeOf(yobit)).apply(this, arguments));
    }

    _createClass(yobit, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend(_get(yobit.prototype.__proto__ || Object.getPrototypeOf(yobit.prototype), 'describe', this).call(this), {
                'id': 'yobit',
                'name': 'YoBit',
                'countries': 'RU',
        ...
        key: 'withdraw',
        value: function () {
            var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(currency, amount, address) {
