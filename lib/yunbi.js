...
module.exports = function (_acx) {
    (0, _inherits3.default)(yunbi, _acx);

    function yunbi() {
        (0, _classCallCheck3.default)(this, yunbi);
        return (0, _possibleConstructorReturn3.default)(this, (yunbi.__proto__ || (0, _getPrototypeOf2.default)(yunbi)).apply(this, arguments));
    }

    (0, _createClass3.default)(yunbi, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend((0, _get3.default)(yunbi.prototype.__proto__ || (0, _getPrototypeOf2.default)(yunbi.prototype), 'describe', this).call(this), {
                'id': 'yunbi',
                'name': 'YUNBI',
                'countries': 'CN',
                'rateLimit': 1000,
