...
module.exports = function (_Exchange) {
    (0, _inherits3.default)(zaif, _Exchange);

    function zaif() {
        (0, _classCallCheck3.default)(this, zaif);
        return (0, _possibleConstructorReturn3.default)(this, (zaif.__proto__ || (0, _getPrototypeOf2.default)(zaif)).apply(this, arguments));
    }

    (0, _createClass3.default)(zaif, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend((0, _get3.default)(zaif.prototype.__proto__ || (0, _getPrototypeOf2.default)(zaif.prototype), 'describe', this).call(this), {
                'id': 'zaif',
                'name': 'Zaif',
                'countries': 'JP',
                'rateLimit': 2000,
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            ...
                            case 4:
                                ...
                                currencies = (0, _keys2.default)(balances['funds']);
