...
module.exports = function (_Exchange) {
    ...
    function zb() {
        ...
        return _possibleConstructorReturn(this, (zb.__proto__ || Object.getPrototypeOf(zb)).apply(this, arguments));
    }

    _createClass(zb, [{
        key: 'describe',
        value: function describe() {
            return this.deepExtend(_get(zb.prototype.__proto__ || Object.getPrototypeOf(zb.prototype), 'describe', this).call(this), {
                'id': 'zb',
                'name': 'ZB',
                'countries': 'CN',
                'rateLimit': 1000,
